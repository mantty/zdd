...
type (
	...
	CommandExecutor interface {
		...
		ExecuteCommandWithEnv(command string, workingDir string, env map[string]string) error
	}
...
func (e *ShellCommandExecutor) ExecuteCommandWithEnv(command string, workingDir string, env map[string]string) error {
	if strings.TrimSpace(command) == "" {
		return nil
	}
